...
$(function(){Handlebars.registerHelper("elipses",function(e){return e.length>100?e.substr(0,99)+"...":e}),Handlebars.registerHelper("date",function(e){return moment(e).format("MMMM D, YYYY")}),$.ajax({url:"https://api.github.com/users/rovalles/repos",type:"GET",dataType:"jsonp",processDataBoolean:!0,success:function(e){var t=$("#github");source=t.html(),template=Handlebars.compile(source),t.replaceWith(template(e))}})});